...
public class ClassServiceImpl implements ClassService {
    ...
    public ClassEntity createClass(ClassRequest request) {
        ...
        if (classEntityRepository.existsByGradeAndSectionAndYear(request.grade(), request.section(), request.year())) {
            throw new IllegalArgumentException("Class already exists: " + request.grade() + "-" + request.section());
        }
